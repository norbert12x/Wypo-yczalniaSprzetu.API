...
namespace WypożyczalniaSprzetu.API.Migrations
{
    ...
    [Migration("20250723085218_RenameTableName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WypozyczalniaSprzetu.API.Models.Sprzet", b =>
                {
                    ...
                    b.Property<int>("KategoriaSprzetuId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WypożyczalniaSprzetu.API.Models.KategorieSprzetu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WypożyczalniaSprzetu.API.Models.Klient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WypozyczalniaSprzetu.API.Models.Rezerwacja", b =>
                {
                    b.HasOne("WypożyczalniaSprzetu.API.Models.Klient", "Klient")
                        .WithMany("Rezerwacje")
            ...
            modelBuilder.Entity("WypozyczalniaSprzetu.API.Models.Sprzet", b =>
                {
                    b.HasOne("WypożyczalniaSprzetu.API.Models.KategorieSprzetu", "KategorieSprzetu")
                        .WithMany("Sprzety")
